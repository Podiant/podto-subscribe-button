...
var EventEmitter = function EventEmitter() {
    ...
    this.off = function (e, callback) {
        ...
        var index = _callbacks[e].indexOf(callback);
    ...
    this.emit = function (e, args) {
        ...
        _callbacks[e].forEach(function (ev) {
            value = ev.apply(_this, args);
        });
...
(function (fn) {
    ...
    document.querySelectorAll('[data-action="podto:subscribe"]').forEach(function (element) {
        var button = new _button2.default(element);
    });
});
...
var _routes2 = __webpack_require__(332);
...
var Button = function (_EventEmitter) {
    ...
    function Button(element) {
        ...
        element.addEventListener('click', function (e) {
            ...
            e.preventDefault();
            _this.emit('run', [url, type]);
        });

        _this.on('run', function (url, type) {
            var _routes = [].concat(_toConsumableArray(_routes3.default));

            var nextRoute = function nextRoute() {
                if (_routes.length) {
                    var route = _routes.shift();

                    console.debug('Trying ' + route.name + ' route');
                    new route(url, type).run().then(console.info('Apparently that worked')).catch(function (err) {
...
var Route = function (_EventEmitter) {
    ...
    function Route(name, url) {
        var type = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : 'application/xml';
...
var MobileRoute = function (_Route) {
    _inherits(MobileRoute, _Route);

    function MobileRoute(url, type) {
        var _this3 = this;

        _classCallCheck(this, MobileRoute);

        var _this2 = _possibleConstructorReturn(this, (MobileRoute.__proto__ || Object.getPrototypeOf(MobileRoute)).call(this, 'mobile', url, type));

        _this2.run = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee() {
            return regeneratorRuntime.wrap(function _callee$(_context) {
                while (1) {
                    switch (_context.prev = _context.next) {
                        case 0:
                            return _context.abrupt('return', _this2.navigate( true ? '&type=' + encodeURIComponent(_this2.type) : ''));
...
var DesktopRoute = function (_Route2) {
    _inherits(DesktopRoute, _Route2);

    function DesktopRoute(url, type) {
        var _this5 = this;

        _classCallCheck(this, DesktopRoute);

        var _this4 = _possibleConstructorReturn(this, (DesktopRoute.__proto__ || Object.getPrototypeOf(DesktopRoute)).call(this, 'desktop', url, type));

        _this4.run = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee2() {
            return regeneratorRuntime.wrap(function _callee2$(_context2) {
                while (1) {
                    switch (_context2.prev = _context2.next) {
                        case 0:
                            return _context2.abrupt('return', _this4.navigate( true ? '&type=' + encodeURIComponent(_this4.type) : ''));
...
var RawRoute = function (_Route3) {
    _inherits(RawRoute, _Route3);

    function RawRoute(url, type) {
        var _this7 = this;

        _classCallCheck(this, RawRoute);

        var _this6 = _possibleConstructorReturn(this, (RawRoute.__proto__ || Object.getPrototypeOf(RawRoute)).call(this, 'raw', url, type));

        _this6.run = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee3() {
            return regeneratorRuntime.wrap(function _callee3$(_context3) {
                while (1) {
                    switch (_context3.prev = _context3.next) {
                        case 0:
                            return _context3.abrupt('return', _this6.navigate(_this6.url));
...
var routes = [MobileRoute, DesktopRoute, RawRoute];

exports.default = routes;

/***/ })
/******/ ]);
//# sourceMappingURL=podto-subscribe-button.js.map